...
Below we have included code you can use to simulate posterior predictive data given  the `sampled` object is loaded in your work environment. `n` specifies the number of posterior samples. To generate this you will to load your `sampled` object for the 3b model.
      ...
      for (i in 1:length(iterations)) {
       print(i)
        ...
        if (i == 1){
          ...
          pp_data[[s]] = rbind(pp_data[[s]], cbind(pp_subj = i, out))
        }
      }
    }
    if (rbind.data){
    tidy_pp_data = do.call(rbind, pp.data)  
    return(tidy.pp.data)
    }
    else {
      return(pp.data)
...
pp_data_3b <- generate.ppdata(sampled, n = 20)
```

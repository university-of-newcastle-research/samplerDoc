...
There are a number of preliminary steps we need to complete before running the sampler. As mentioned above, we'll use the Linear Ballistic Accumulator (LBA) [@brown2008simplest] in this example. The LBA model parameters are:
...
The log-likelihood function shown below uses functions from the rtdists package for generating data and estimating density. 

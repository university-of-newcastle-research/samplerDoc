...
As we did for the the three threshold LBA model, we generate 20 posterior predictive data samples. 
Note: this function is taken from \@ref(genppdatafunc)
```{r part10.5.3, eval=FALSE}
pp.data.1b <- gen_pp_data(sampled, n = 20)
```

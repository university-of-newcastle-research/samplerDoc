# Sequential Sampling models with PMwG sampler 
...
Before we begin, please ensure the psamplers package is installed. We currently recommended installing psamplers via devtools.
```{r getpkg, eval=FALSE}
...
As mentioned above, we'll use the Linear Ballistic Accumulator (LBA) [@brown2008simplest] in this example. The LBA model parameters are:

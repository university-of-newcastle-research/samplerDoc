...
2. Produce profile plots to compare the log-likelihood of the `x` parameter values against nearby values in the 'synethetic' data. You can write your own function for this, or use the function below. 
...
# incorrect_ll_plots <- pmwg_profilePlot(x = x,
#                               n_values = 9,

...
In this section we will evaluate different LBA models. For each model, we will the estimate posterior distribution, generate posterior predictive data, and then compare those against real data.
...
* `n_values` specifies how many parameter x-values we will assess to compare to the data-generating parameter values. Default is 9.
* `synth_data` is the synthetic data

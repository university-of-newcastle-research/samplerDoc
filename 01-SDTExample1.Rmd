...
Now that we've covered a simple test example, let's create a log likelihood function for the @wagenmakers2008diffusion dataset. Before we do that, we need to cover the design of Wagenmakerssss study.
...
For more details about the experiment please see [the original paper](https://www.sciencedirect.com/science/article/pii/S0749596X07000496).  <b> Is this the correct paper to reference? I have changed the name of the columns in the wagenmakers dataset to the names used in the table shown below.</b>
...
<b> Remove SLOW part of ll function?</b>

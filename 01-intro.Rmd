# Sampler Application Example 1 - Forstmann et al. (2008) dataset
...
The first line in the `lba_loglike` function (Line 2 below) takes the exponent of the parameter values to move all parameter values to the real number scale. <b>The purpose of this is to..... </b>

 ...
 * you may be making a vector for b for all the values across the data set to be used, but there are NAs filling it somewhere)
...
<b> Data frame variables are scaled correctly i.e. correct units
